...
var or__18496__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__18496__auto__)){
return or__18496__auto__;
} else {
var or__18496__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__18496__auto____$1)){
return or__18496__auto____$1;
} else {
var or__18496__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__18496__auto____$2)){
return or__18496__auto____$2;
} else {
var or__18496__auto____$3 = (w["msRequestAnimationFrame"]);
...
var n__19411__auto__ = a.length;
var i = (0);
while(true){
if((i < n__19411__auto__)){
var c_38256 = (a[i]);
if(cljs.core.truth_((c_38256["cljsIsDirty"]))){
(c_38256["forceUpdate"])();
} else {
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__19102__auto__,writer__19103__auto__,opt__19104__auto__){
return cljs.core._write.call(null,writer__19103__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__38260 = c;
var G__38260__$1 = (((G__38260 == null))?null:(G__38260["props"]));
if((G__38260__$1 == null)){
return null;
} else {
return (G__38260__$1["argv"]);
}
});
...
var G__38262_38263 = (c["cljsRatom"]);
if((G__38262_38263 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__38262_38263);
}

return reagent.impl.batching.mark_rendered.call(null,c);
});

//# sourceMappingURL=batching.js.map?rel=1466621246148